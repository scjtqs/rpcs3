	...
	*/
	...
	framebuffer_layout thread::get_framebuffer_layout(rsx::framebuffer_creation_context context)
	{
		...
		case rsx::framebuffer_creation_context::context_draw:
			...
			depth_buffer_unused = !depth_test_enabled && !depth_write_enabled && !stencil_test_enabled;
		...
		if (!packed_render)
		{
			...
			minimum_zeta_pitch = color_texel_size * write_limit_x;
			minimum_color_pitch = depth_texel_size * write_limit_x;
		}
